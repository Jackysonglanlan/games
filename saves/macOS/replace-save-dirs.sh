...
# Red Dead Redemption 2 的存档位置比较特殊，好像每个版本都不一样
#   - v1491.50(最终版)，相对于 bottle 目录: `drive_c/users/crossover/AppData/Roaming/.1911/Red Dead Redemption 2/profile`
#
# 目前支持 v1491.50，执行后，会在 '.1911/Red Dead Redemption 2' 下新建一个指向 '$SOURCE_DIR/Red Dead Redemption 2/save_dir' 的 soft-link 目录，名字为 profile
#
# E.g:
#  $ ./replace-save-dirs.sh link_RDR2 win10-64
#
# $1: bottle_name, like 'win10-64'
link_RDR2() {
  local bottle_name=${1:?\$1 missing: bottle_name}

  local src_save_dir="$SOURCE_DIR/Red Dead Redemption 2/save_dir"
  local target_link_dir="$HOME/Library/Application Support/CrossOver/Bottles/$bottle_name/drive_c/users/crossover/AppData/Roaming/.1911/Red Dead Redemption 2/profile"
