...
| Need for Speed(TM) Hot Pursuit 14                      | `26`                                | 声音有重音, 完美存档: 把 `config.NFS11Save` 和 `Save` 放到 `~/Documents/Criterion Games/Need for Speed(TM) Hot Pursuit`                    |
| Tactics.Ogre.Reborn.v1.0.5.0-GoldBerg                  | `26`                                | D3DMetal 完美运行                                                                                                                          |
| TRIANGLE STRATEGY                                      | `26`                                | 完美运行                                                                                                                                   |
| ...                                                    | ...                                 | ...                                                                                                                                        |
